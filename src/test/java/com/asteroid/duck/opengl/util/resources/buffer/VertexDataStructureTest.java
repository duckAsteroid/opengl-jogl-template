...
class VertexDataStructureTest {
	...
	public void testNormalUsage() {
		VertexDataStructure subject = new VertexDataStructure(VertexDataBufferTest.TEST_ELEMENTS);
		...
		assertEquals(1f, object.get(VertexDataBufferTest.TEST_ELEMENTS[0]));
		assertEquals(new Vector2f(2f, 3f), object.get(VertexDataBufferTest.TEST_ELEMENTS[1]));
		assertEquals(new Vector2f(4f, 5f), object.get(VertexDataBufferTest.TEST_ELEMENTS[2]));
		assertEquals(new Vector3f(6f, 7f, 8f), object.get(VertexDataBufferTest.TEST_ELEMENTS[3]));
	}
