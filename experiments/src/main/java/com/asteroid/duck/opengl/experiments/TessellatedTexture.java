...
public class TessellatedTexture implements Experiment {
	...
	private void updateBufferData() {
		...
		this.buffer.update(UpdateHint.DYNAMIC);
	}
	...
	public String getDescription() {
		return "A texture renderer that draws random boxes of the texture ";
	}
}
